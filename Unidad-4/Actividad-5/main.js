class SolicitudApiTabla extends HTMLElement {
    ...
    connectedCallback() {
        // Ejecutamos render al conectar el componente
        this.render();
    }
    ...
    // Lógica para obtener la lista de usuarios (fetch integrado - Actividad 4)
    ...
    construirTabla(datos, contenedor) {
        ...
        datos.forEach(user => {
            ...
            // 🚨 Añadido en Actividad 5: Click para abrir el modal 🚨
    ...
    // Lógica para obtener los detalles del usuario (Añadido en Actividad 5)
    async mostrarDetallesModal(userId) {
        ...
        try {
            // 🚨 Segundo fetch para los detalles específicos 🚨
            ...
            // Construcción del Contenido del Modal (sin innerHTML para la estructura)
            // Se usa innerHTML solo para las etiquetas de formato (i, strong).
